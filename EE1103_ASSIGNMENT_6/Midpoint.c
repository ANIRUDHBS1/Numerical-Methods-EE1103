...
int main()
{
   FILE *fp;
   fp = fopen("Text.txt","w");
   double xi,yi,yi1,xi12,yi12,h; //xi - Present x value, yi - Present y value, y+1 - Next y value obtained using Eulers method, h - Interval size, xi12 and yi12 are values at the mid-point obtained using the algorithm
